...
from src.components.session_preview import render_session_preview
from src.components.form_session_creation import render_session_creation_form
    ...
    with col2:
        with st.container(border=True):
            ...
            if not scenario:
                ...
                render_session_preview(_get_selected_scenario())
